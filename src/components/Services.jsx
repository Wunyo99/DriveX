      ...
      <div className="container mx-auto px-6">
        <div className="mb-14 text-center">
          ...
          <h2 className="mt-4 text-4xl font-bold text-white">
            <span className="text-green-900">Premium</span> Automotive <span className="text-lime-300">Services</span>
          </h2>
          ...
          {services.map((service) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="mb-4 text-xl font-semibold text-lime-300">{service.title}</h3>
